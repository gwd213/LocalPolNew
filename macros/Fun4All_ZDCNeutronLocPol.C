...
void Fun4All_ZDCNeutronLocPol(const std::string &fname = "/sphenix/lustre01/sphnxpro/physics/slurp/calophysics/run_00044700_00044800/DST_TRIGGERED_ZDC_EVENT_run2pp_new_2024p001-00044702-0000.root", const std::string &outname = "zdcneutronlocpol_44702_0000.root", int startEvent = 0, int nEvents = 10000)
