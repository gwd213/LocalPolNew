...
float ZDC1CUT = 60; // keep above (nominal 65)
float ZDC2CUT = 10; // keep above (nominal 25)
float VETOCUT = 9999; // keep below (nominal 150)
...
void drawAsym(const std::string infile = "/sphenix/tg/tg01/coldqcd/ZDCLocalPol/test/store34578/store34578.root", int storenumber = 34578, int runnumber = 44701)
